<template>
  <div class="quality-features bg-light p-5">
    <v-container fluid>
      <v-row>
        <v-col v-for="card in cards" :key="card.title">
          <v-card height="400" class="features" elevation="0">
            <div
              class="d-flex justify-center align-center flex-column text-center"
            >
              <span class="mb-10" v-html="card.svg"></span>
              <v-card-title
      ...
      cards: [
        {
          ...
          discription: "comprehensive quality control and affordable proces",
          svg: `
            <svg
              aria-hidden="true"
              focusable="false"
            ...
            >
              <defs>
                ...
                >
                  {" "}
                  <stop offset="0%" stop-color="#6423d1">
                    {" "}
                  </stop>{" "}
                  <stop offset="100%" stop-color="#a215e1">
                    {" "}
                  </stop>{" "}
                </linearGradient>{" "}
              </defs>
