<template>
  <v-footer>
    <v-container fluid>
      <v-row class="bg-light p-5">
        <v-col cols="3">
          <div class="bg-white p-3">
            <h4 class="mb-5">SHOP</h4>
            <ul
              class="nav nav-links d-flex justify-space-around pt-2 flex-column"
            >
              <li v-for="cat in categories" :key="cat.title" class="mb-3">
                <router-link
                  :to="{
        ...
        <v-col cols="3">
          <div class="bg-white p-3">
            <h4 class="mb-5">FURTHER INFO</h4>
            <p>Abount</p>
            <p>Customer service</p>
            <p>Reward Program</p>
            <p>Shippimg & Returns</p>
            <p>privacy Policy</p>
        ...
        <v-col cols="3">
          <div class="bg-white p-3">
            <img class="mb-15" src="../../assets/images/footer-logo.webp" />
            <div class="mb-5">
              <span
                ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                  ...
                  ></path></svg
              ></span>
              <span>545 Market Street San Francisco</span>
            </div>
            <div class="mb-5">
              <span
                ><svg
                ...
                >
                  ...
                  ></path></svg
              ></span>
              <span>Call Us at 01091025458</span>
            </div>
            <div class="mb-5">
              <span
                ><svg
      ...
      <v-row class="d-flex justify-space-between">
        <v-col cols="6">
          <div class="text-start pt-5">
            <p>2024 Eilla DEmo All Rights REserved Pwered BY jiwsvdfe</p>
            <p>2024 Eilla DEmo All Rights REserved Pwered BY jiwsvdfe</p>
          </div>
        </v-col>
