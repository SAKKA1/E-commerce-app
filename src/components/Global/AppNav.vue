<template>
  <v-app-bar color="#161880" height="auto" absolute="">
    <v-container fluid>
      <v-row>
        <v-col cols="3">
          <router-link to="/"
        ...
        <v-col cols="5">
          <input
            type="search"
            class="w-100 p-2 bg-white rounded"
            style="outline: none"
        ...
        <v-col cols="4">
          <div class="parent d-flex justify-space-between align-center">
            <div class="available me-2">
              <span>Available 24/7 at</span>
              <br />
              <strong>(080)88541277</strong>
            </div>
            <div
              class="whish-lists d-flex flex-column justify-center align-center"
            >
      ...
      <v-row>
        <v-col cols="9" class="nav-bar">
          <ul class="nav nav-links d-flex justify-space-around text-right">
        ...
        <v-col cols="3">
          <div class="parent d-flex justify-content-around">
            ...
            <div class="lang cursor-pointer" id="lang-btn">
