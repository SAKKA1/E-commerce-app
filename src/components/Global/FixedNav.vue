<template>
  <v-app-bar color="#161880" class="fixed-nav">
    <v-container fluid>
      <v-row>
        <v-col cols="3">
          <router-link to="/"
        ...
        <v-col cols="7">
          <ul class="nav nav-links d-flex justify-space-around pt-2">
        ...
        <v-col cols="2">
          <div class="parent d-flex justify-space-around align-center">
            <div>
              <svg
                data-icon="search"
                viewBox="0 0 512 512"
            ...
            <div class="cart d-flex flex-column justify-center align-center">
              <v-badge
                location="right top"
                color="blue"
                offset-x="-10"
